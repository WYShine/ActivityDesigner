...
public class Upload {
	...
	public Upload(File file) throws ClientProtocolException, IOException
	{
		...
		int TIME_OUT = 10 * 10000;	//超时时间
		try {
			URL url = new URL(ConUtils.UpLoadUrl);
			...
			if(file != null)
			{
                ...
                Log.i("xxxxxxxxxxxx",String.valueOf(res));
                if(res == 200)
                {
                	return ;
                }
